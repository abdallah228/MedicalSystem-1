...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-5 m-1">
                            <a href="{{route('setting.create')}}" class="btn btn-success mb-4 mt-2"><i class = "fa fa-plus"></i> Add New </a>
                        </div>
                        <div class="col-6">
                            <!-- Actual search box -->
                    ...
                    <tbody id="myTable">
                        ...
                        <td>
                            <div class="row">
                                <div class="col-10 col-md-3">
                                    <!-- Delete Button -->
                                    <form method="post" action="{{route('setting.changeStatues',$record->id)}}"
                        ...
                        <div class="row">
                            <div class="col-10 col-md-3">
                                <!-- Delete Button -->
                                <form method="post" action="{{route('setting.destroy',$record->id)}}"
                                    enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    @method('delete')
                                    <input type="hidden" value="{{$record->id}}" name="id">
                            ...
                            <div class="col-10 col-md-3">
                                <!-- Edit Button -->
                                <form method="post"
                                    action= "{{route('setting.edit',$record->id)}}"
                                    enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @method('get')
                                        <input type="hidden" value="{{$record->id}}" name="id">
                            ...
                            <div class="col-10 col-md-3">
                                <!-- Show Button -->
                                <form method="post"
                                    action= "{{route('setting.show',$record->id)}}"
                                    enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        @method('get')
                                        <input type="hidden" value="{{$record->id}}" name="id">
